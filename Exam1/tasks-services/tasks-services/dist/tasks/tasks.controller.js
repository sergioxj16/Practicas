...
const update_finished_dto_1 = require("./dto/update-finished.dto");
...
let TasksController = class TasksController {
    ...
    async update(id, updateFinished) {
        return {
...
__decorate([
    (0, common_1.Put)(':id/finished'),
    __param(0, (0, common_1.Param)('id')),
    __param(1, (0, common_1.Body)(new common_1.ValidationPipe({ transform: true, whitelist: true }))),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_finished_dto_1.UpdateFinishedDto]),
    __metadata("design:returntype", Promise)
